...
//                 </Text>
//                 <Text style={styles.modalText}>
//                   Department ID: {selectedCourse.departmentId}
//                 </Text>
//                 <Text style={styles.modalText}>
//                   Duration: {selectedCourse.duration}
//                 </Text>
//                 <Text style={styles.modalText}>
//                   Certification Name: {selectedCourse.certificationName}
//                 </Text>
//                 <TouchableOpacity
//                   style={styles.button}
...
//                   onChangeText={(text) =>
//                     setNewCourse({ ...newCourse, departmentId: parseInt(text) })
//                   }
//                 />
//                 <TextInput
//                   style={styles.input}
...
//                   onChangeText={(text) =>
//                     setNewCourse({ ...newCourse, certificationName: text })
//                   }
//                 />
//                 <TouchableOpacity
//                   style={styles.button}
